        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="group relative flex flex-col items-center pt-10 px-6 pb-0 rounded-[2.5rem] bg-white/[0.02] border border-white/5 overflow-hidden h-[550px] transition-colors duration-500 hover:border-cyan-400/50 hover:bg-white/[0.04]"
            >
              {/* Inner Glow on Hover */}
